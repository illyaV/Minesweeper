...
(function(window, $, React){
  ...
  var Game = React.createClass({displayName: "Game",
    ...
    makeRows: function() {
      ...
      return this.state.matrix.map(function(row, y) {
        return (React.createElement("tr", null, row.map(function(item, x){
          return (React.createElement(Field, {value: item.value, opened: item.opened, marked: item.marked, onOpen: self.onOpenField.bind(self, x, y), onMark: self.onMarkField.bind(self, x, y)}));
        })));
      });
    }
  });
  ...
  React.render(
    React.createElement(Game, {x: "16", y: "16", bombsCount: "15"}),
